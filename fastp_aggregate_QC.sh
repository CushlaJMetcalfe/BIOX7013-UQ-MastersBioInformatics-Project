...
json_dir="/mnt/data/cushla/gutmeta/sequencing/passQC_reads/1a_fastp" # directory fastp qc json files
reports_dir="/mnt/data/cushla/gutmeta/reports/preprocessing" # output directory for output file
fastp_aggregate_csv="fastp_qc_aggregate.csv" # output file from python json aggregate script
fastp_failed_txt="fastp_failed_samples.txt" # list of failed samples
cut_off=500000 # threshold for failed samples (number of reads)
...
python ${script_dir}/fastp_aggregate_json_files.py \
	...
	--cutoff ${cut_off} \
        > "${reports_dir}/logs/p_fastp_json.out" \
        2> "${reports_dir}/logs/p_fastp_json.err"
